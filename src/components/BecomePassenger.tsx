...
export function BecomePassenger() {
  ...
  return (
    <section
      id="become-passenger"
      className="py-24 px-4 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50"
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-4">
            You&apos;ve seen the videos. You&apos;ve watched strangers turn into
            performers, hype machines, best friends, and sometimes therapy
            clients in the backseat.
          </p>
            ...
            <CardContent className="pt-0 px-8 pb-8">
              <ul className="space-y-3 mb-6 text-left">
                ...
                <li className="flex items-start">
                  <span className="text-green-600 mr-2 font-bold">•</span>
                  <span className="text-gray-600">
                    Choose your song, bring your people, set your vibe.
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-2 font-bold">•</span>
            ...
            <CardContent className="pt-0 px-8 pb-8">
              <ul className="space-y-3 mb-6 text-left">
                <li className="flex items-start">
                  <span className="text-green-600 mr-2 font-bold">•</span>
                  <span className="text-gray-600">
                    Everything included in The Tripman Experience.
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-2 font-bold">•</span>
            ...
            <CardContent className="pt-0 px-8 pb-8">
              ...
              <div className="bg-green-50 rounded-lg p-4 mb-6 text-center border-t pt-4">
                <p className="text-sm text-gray-600 mb-2">
                  Prices are determined after a short discovery process
                  conducted by
                </p>
                <p className="font-bold text-green-600">
                  Afes Digital, The Tripman&apos;s representative agency.
                </p>
