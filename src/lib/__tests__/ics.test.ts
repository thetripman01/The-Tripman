...
describe('ICS Generation', () => {
  ...
  describe('generateICS', () => {
    it('should generate valid ICS content structure', () => {
      ...
      expect(icsContent).toContain('SUMMARY:Birthday Uber Ride with The TripMan')
    ...
    it('should include reminder', () => {
      ...
      expect(icsContent).toContain('DESCRIPTION:Reminder: Your TripMan booking is in 15 minutes')
